                                        ...
                                        <div
                                            ...
                                            <div class="product-img">
                                                <a href="product-details.html"><img
                                                        src="{{ asset('frontend/img/product-3/6.jpg') }}"
                                                        alt="#"></a>
                                                <div class="real-estate-agent">
                                                    <div class="agent-img">
                                                        <a href="team-details.html"><img
                                                                src="{{ asset('frontend/img/blog/author.jpg') }}"
                                                                alt="#"></a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row" id="product-list">
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('frontend/img/product-3/1.jpg') }}"
                                                    alt="#"></a>
                                        </div>
                                        <div class="product-info">
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('frontend/img/product-3/2.jpg') }}"
                                                    alt="#"></a>
                                        </div>
                                        <div class="product-info">
                                            <div class="product-badge-price">
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('frontend/img/product-3/3.jpg') }}"
                                                    alt="#"></a>
                                        </div>
                                        <div class="product-info">
                                            <div class="product-badge-price">
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('frontend/img/product-3/4.jpg') }}"
                                                    alt="#"></a>
                                        </div>
                                        <div class="product-info">
                                            <div class="product-badge-price">
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('frontend/img/product-3/5.jpg') }}"
                                                    alt="#"></a>
                                        </div>
                                        <div class="product-info">
                                            <div class="product-badge-price">
                        ...
                        <ul>
                            <li>
                                <div class="top-rated-product-item clearfix">
                                    <div class="top-rated-product-img">
                                        <a href="product-details.html"><img
                                                src="{{ asset('frontend/img/product/1.png') }}" alt="#"></a>
                                    </div>
                            ...
                            <li>
                                <div class="top-rated-product-item clearfix">
                                    <div class="top-rated-product-img">
                                        <a href="product-details.html"><img
                                                src="{{ asset('frontend/img/product/2.png') }}" alt="#"></a>
                                    </div>
                                    <div class="top-rated-product-info">
                                        <div class="product-ratting">
                                            <ul>
                            ...
                            <li>
                                <div class="top-rated-product-item clearfix">
                                    <div class="top-rated-product-img">
                                        <a href="product-details.html"><img
                                                src="{{ asset('frontend/img/product/3.png') }}" alt="#"></a>
                                    </div>
                                    <div class="top-rated-product-info">
                                        <div class="product-ratting">
                                            <ul>
                    ...
                    <div class="col-xl-6 col-sm-6 col-12">
                        <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                            ...
                            <div class="product-info">
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badg">${product.brand}</li>
                                    </ul>
                                </div>
                                ...
                                <div class="product-img-location">
                                    <ul>
                                        <li>
                                            <a href="locations.html"><i class="flaticon-pin"></i> ${product.description}</a>
                                        </li>
                                    </ul>
                                </div>
                                <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                                    <li><span>${product.rating} </span>Bed</li>
                                    <li><span>${product.stock} </span>Bath</li>
                                    <li><span>${product.price} </span>Square Ft</li>
                                </ul>
                                <div class="product-hover-action">
                                    <ul>
                                        <li>

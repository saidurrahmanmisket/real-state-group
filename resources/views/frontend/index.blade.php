...
@section('content')
 ...
 @include('frontend.components.hero-slide')
    <!-- SLIDER AREA END -->

    <!-- CAR DEALER FORM AREA START -->
    @include('frontend.components.search-property')
    <!-- CAR DEALER FORM AREA END -->

    <!-- BANNER AREA START ( Banner - 4 ) -->
   @include('frontend.components.property-categoorie')
    <!-- BANNER AREA END -->

    <!-- FEATURE AREA START ( Feature - 6) -->
   @include('frontend.components.core-feature')
    <!-- FEATURE AREA END -->

    <!-- CALL TO ACTION START (call-to-action-4) -->
    @include('frontend.components.call-for-question')
    <!-- CALL TO ACTION END -->

    <!-- VIDEO AREA START -->
    @include('frontend.components.video-area')
    <!-- VIDEO AREA END-->
    ...
    @include('frontend.components.img-slider-portfolio')
